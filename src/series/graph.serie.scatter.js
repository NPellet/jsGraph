        ...
        if (isCategory) {
            ...
            for (; j < this.data.length; j++) {
                ...
                for (var n = 0, l = this.data[j].y.getLength(); n < l; n++) {
                    ...
                    xpx = this.getX((n / (l - 1)) * (0.8 / this.nbCategories) +
            ...
            for (; j < this.waveform.getLength(); j++) {
                if (this.waveform.getX(j) < this.getXAxis().getCurrentMin() ||
    ...
    getMarkerStyle(indices, noSetPosition) {
        ...
        for (let i in computedStyles) {
            ...
            if (typeof computedStyles[i].markers.all == 'function') {
                ...
                styleAll[i] = Object.assign({}, computedStyles[i].markers.all);
            }
            if (computedStyles[i].markers.default) {
                styleAll[i] = Object.assign(Object.assign({}, computedStyles[i].markers.default), styleAll[i]);
            }
        }
        ...
        for (let i = 0, l = _indices.length; i < l; i++) {
            ...
            let modifier = (_a = this.getRawStyle(sName).markers) === null || _a === void 0 ? void 0 : _a.modifiers;
            ...
            if (modifier && (modifierIsFunc || modifier[index])) {
                ...
                styles[index] = Object.assign(Object.assign({}, styleAll[sName]), modifiedStyle);
            }
            else {
