 ...
 * @extends Serie
 */
class SerieHistogram extends SerieLine implements SerieInterface {

  public options: SerieHistogramOptions;
 ...
 */
  ...
  getFillOpacity() {
    return this.getComputedStyle().histogram?.fillOpacity;
  }
