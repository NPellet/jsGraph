...
var _graph = _interopRequireDefault(__webpack_require__(1107));

var util = _interopRequireWildcard(__webpack_require__(4167));

var _graphMixinEvent_graph = _interopRequireDefault(__webpack_require__(5452));
...
class Axis {
  ...
  */
  ...
  drawLinearTicksWrapper(widthPx, valrange) {
    ...
    this._primaryTickIncrement = tickPrimaryUnit; // We need to get here the width of the ticks to display the axis properly, with the correct shift
  ...
  setTickPosition(pos) {
    switch (pos) {
      case 3:
      case 'outside':
      case _graph.default.TICKS_OUTSIDE:
        {
          pos = 3;
          break;
        }
      ...
      case 2:
      case 'centered':
      case _graph.default.TICKS_CENTERED:
        {
          pos = 2;
          break;
        }
      ...
      case 1:
      case 'inside':
      case _graph.default.TICKS_INSIDE:
      default:
        {
          pos = 1;
          break;
...
var _graphAxisX = _interopRequireDefault(__webpack_require__(9763));
 ...
 * @augments Axis
 */
class AxisXBar extends _graphAxisX.default {
...
var _graphAxis = _interopRequireDefault(__webpack_require__(4349));
 ...
 * @augments Axis
 */
class AxisX extends _graphAxis.default {
  constructor(graph, topbottom, options = {}) {
    super(graph, topbottom, options);
  ...
  drawTick(value, level, options, forcedPos) {
    ...
    const yCoord = (self.top ? -1 : 1) * ((self.options.tickPosition == 1 ? 8 : 20) + (self.top ? 10 : 0)) + this.options.tickLabelOffset; //  this.groupTicks.appendChild( tick );
...
class GraphTimeAxis extends _graphAxis.default {
  constructor() {
    super(...arguments);
  }
 ...
 * @extends Axis
 */
class AxisY extends _graphAxis.default {
...
exports.default = exports.nsxlink = exports.ns = exports.__VERSION__ = void 0;

var _graphPosition = _interopRequireDefault(__webpack_require__(8697));

var util = _interopRequireWildcard(__webpack_require__(4167));

var _mixin = _interopRequireDefault(__webpack_require__(7035));

var _graphMixinEvent = _interopRequireDefault(__webpack_require__(6871));

var _waveform = __webpack_require__(1748);

var _series = __webpack_require__(2513);
...
exports.nsxlink = nsxlink;
var AxisPositionE;

(function (AxisPositionE) {
  AxisPositionE["TOP"] = "top";
  AxisPositionE["BOTTOM"] = "bottom";
  AxisPositionE["LEFT"] = "left";
  AxisPositionE["RIGHT"] = "right";
})(AxisPositionE || (AxisPositionE = {}));
...
class Graph {
   ...
   */
  constructor(wrapper, options, axes = {
    [AxisPositionE.TOP]: [],
    ...
    _defineProperty(this, "nsxlink", void 0);

    _defineProperty(this, "uid", util.guid());
    ...
    _defineProperty(this, "shapesLocked", false);

    _defineProperty(this, "plugins", void 0);

    _defineProperty(this, "selectedShapes", void 0);

    _defineProperty(this, "series", void 0);

    _defineProperty(this, "_axesHaveChanged", void 0);

    _defineProperty(this, "currentAction", void 0);
    ...
    _defineProperty(this, "domTitle", void 0);

    _defineProperty(this, "sizeSet", void 0);

    _defineProperty(this, "_lockUpdate", false);

    _defineProperty(this, "legend", void 0);

    _defineProperty(this, "innerHeight", void 0);

    _defineProperty(this, "innerWidth", void 0);

    _defineProperty(this, "offsetCached", void 0);

    _defineProperty(this, "axisGroup", void 0);

    _defineProperty(this, "groupPrimaryGrids", void 0);

    _defineProperty(this, "groupSecondaryGrids", void 0);

    _defineProperty(this, "markerHorizontalSplit", void 0);

    _defineProperty(this, "markerVerticalSplit", void 0);

    _defineProperty(this, "markerArrow", void 0);

    _defineProperty(this, "clip", void 0);

    _defineProperty(this, "clipRect", void 0);

    _defineProperty(this, "rectEvent", void 0);

    _defineProperty(this, "savedAxisState", void 0);

    _defineProperty(this, "selectedSerie", void 0);

    _defineProperty(this, "toolbar", void 0);

    _defineProperty(this, "cancelUnselectShape", void 0);

    _defineProperty(this, "layers", void 0);

    _defineProperty(this, "plotGroup", void 0);

    _defineProperty(this, "bypassHandleMouse", void 0);

    _defineProperty(this, "drawn", false);

    _defineProperty(this, "closingLines", void 0);

    _defineProperty(this, "graphingZone", void 0);

    _defineProperty(this, "forcedPlugin", void 0);

    _defineProperty(this, "activePlugin", void 0);

    _defineProperty(this, "zAxis", void 0);

    _defineProperty(this, "groupGrids", void 0);

    _defineProperty(this, "groupEvent", void 0);

    _defineProperty(this, "_sizeChanged", false);

    _defineProperty(this, "drawingSpaceWidth", void 0);

    _defineProperty(this, "drawingSpaceHeight", void 0);

    _defineProperty(this, "drawingSpaceMinX", void 0);

    _defineProperty(this, "drawingSpaceMinY", void 0);

    _defineProperty(this, "drawingSpaceMaxX", void 0);

    _defineProperty(this, "drawingSpaceMaxY", void 0);

    _defineProperty(this, "trackingLineShape", void 0);

    _defineProperty(this, "_katexRenderer", void 0);

    _defineProperty(this, "vertLineArrow", void 0);

    _defineProperty(this, "defs", void 0);

    _defineProperty(this, "_trackingLegend", void 0);
    ...
    this.currentAction = false; // Load all axes
    ...
    this._pluginsInit(); // Create SVG element, set the NS
    ...
    */
    ...
    this.groupGrids = document.createElementNS(ns, 'g'); // With the z stacking, this should probably be removed
  ...
  _registerEvents() {
    ...
    */
    ...
    this.groupEvent.addEventListener('wheel', e => {
      const coords = this._getXY(e);
  ...
  getDrawingHeight(useCache = true) {
  ...
  setAxisState(state) {
    ...
    for (var i in state) {
      ...
      for (j = 0, l = state[i].length; j < l; j++) {
        ...
        this.axis[i][j].setCurrentMin(state[i][j][0]); // @ts-ignore
  ...
  newPosition() {
    return new _graphPosition.default(...arguments); // 18 September 2016 Norman: What is that ?
  ...
  isActionAllowed(e, action) {
    ...
    if (action.key) {
      if (action.key !== e.keyCode) {
        ...
        if (Object.keys(keyCheck).includes(action.key) && keyCheck[action.key] !== e.keyCode) {
          return;
        }
      }
    }
  ...
  trackingLine(options) {
    ...
    let backupSeries = []; // If we defined an array, let's save it
  ...
  exportToSchema() {
    ...
    for (let pos in this.axis) {
      axesExport = axesExport.concat(this.axis[pos].map(axis => {
        return {
          type: pos,
      ...
      if (pos == 'top' || pos == 'bottom') {
        allaxes.x = allaxes.x.concat(this.axis[pos]);
      } else {
        allaxes.y = allaxes.y.concat(this.axis[pos]);
      }
    }
    ...
    let toType = type => {
      switch (type) {
        case _series.SERIE_TYPE.BAR:
          return 'bar';

        case _series.SERIE_TYPE.LINE_COLORED:
          return 'color';

        case _series.SERIE_TYPE.SCATTER:
          return 'scatter';

        default:
        case _series.SERIE_TYPE.LINE:
          return 'line';
      }
    };
      ...
      switch (serie.getType()) {
        ...
        case Graph.SERIE_SCATTER:
          for (var j = 0; j < serie.data.length - 1; j += 2) {
            data.push(serie.data[j + (x && serie.isFlipped() || !x && !serie.isFlipped() ? 1 : 0)]);
          }
  ...
  _getAxis(num, options, pos) {
    ...
    if (!this.axis[pos][num]) {
      // @ts-ignore
      this.axis[pos][num] = new inst(this, pos, options);
      this.axis[pos][num].init(this, options);
    }

    return this.axis[pos][num];
  }

  _closeLine(mode, x1, x2, y1, y2) {
  ...
  refreshDrawingZone() {
    ...
    this._applyToAxes((axis, position) => {
      if (!axis.isShown()) {
    ...
    this._applyToAxes(function (axis, pos) {
      if (!axis.floating) {
        return;
      }
    ...
    this._closeLine('right', this.getDrawingWidth(true), this.getDrawingWidth(true), shiftTop, this.getDrawingHeight(true) - shiftBottom);

    this._closeLine('left', 0, 0, shiftTop, this.getDrawingHeight(true) - shiftBottom);

    this._closeLine('top', shiftLeft, this.getDrawingWidth(true) - shiftRight, 0, 0);

    this._closeLine('bottom', shiftLeft, this.getDrawingWidth(true) - shiftRight, this.getDrawingHeight(true) - shiftBottom, this.getDrawingHeight(true) - shiftBottom);

    this.clipRect.setAttribute('y', shiftTop.toString());
    this.clipRect.setAttribute('x', shiftLeft.toString());
    this.clipRect.setAttribute('width', (this.getDrawingWidth() - shiftLeft - shiftRight).toString());
    this.clipRect.setAttribute('height', (this.getDrawingHeight() - shiftTop - shiftBottom).toString());
    ...
    this.drawingSpaceMaxX = this.getDrawingWidth() - shiftRight + this.getPaddingLeft(); // + "px";

    this.drawingSpaceMaxY = this.getDrawingHeight() - shiftBottom + this.getPaddingTop(); //  + "px";
    // Apply to top and bottom
  ...
  static registerConstructor(constructorKey, constructor) {
  ...
  static getConstructor(constructorKey) {
    if (!Graph._constructors.has(constructorKey)) {
  ...
  static getStyle(styleName) {
    return Graph._styles.get(styleName) || _series.SERIE_DEFAULT_STYLE;
  }

}

_defineProperty(Graph, "SERIE_BAR", void 0);

_defineProperty(Graph, "SERIE_LINE_COLORED", void 0);

_defineProperty(Graph, "SERIE_SCATTER", void 0);

_defineProperty(Graph, "SERIE_LINE", void 0);

_defineProperty(Graph, "_constructors", new Map());

_defineProperty(Graph, "_styles", new Map());
  ...
  if (!graph.activePlugin) {
    ...
    if (graph.options.trackingLine && graph.options.trackingLine.enable) {
      if (graph.options.trackingLine.mode == 'common' && graph.options.trackingLine.snapToSerie) {
        ...
        graph._trackingLegend = _trackingLegendSerie(graph, series, xOverwritePx, y, graph._trackingLegend
        /*,
...
function _handleMouseUp(graph, x, y, e) {
  ...
  if (graph.activePlugin) graph._pluginExecute(graph.activePlugin, 'onMouseUp', [graph, x, y, e]);
  graph.activePlugin = undefined;
}
...
function _handleClick(graph, x, y, e) {
  ...
  if ( //@ts-ignore
  !e.target.jsGraphIsShape && !graph.prevent(false) && graph.options.shapesUnselectOnClick) {
...
(0, _mixin.default)(Graph);
(0, _graphMixinEvent.default)(Graph);
var _default = Graph;
exports.default = _default;
...
Object.defineProperty(exports, "SERIE_TYPE", ({
  enumerable: true,
  get: function () {
    return _series.SERIE_TYPE;
  }
}));
exports.default = void 0;
...
var _graphLegend = _interopRequireDefault(__webpack_require__(3187));

var _graphAxisX = _interopRequireDefault(__webpack_require__(9763));

var _graphAxisY = _interopRequireDefault(__webpack_require__(4083));

var _graphAxisXBar = _interopRequireDefault(__webpack_require__(606));

var _graphAxisXTime = _interopRequireDefault(__webpack_require__(9291));

var _graphSerie = _interopRequireDefault(__webpack_require__(7645));

var _graphSerie2 = _interopRequireDefault(__webpack_require__(1755));

var _graphSerieLine3d = _interopRequireDefault(__webpack_require__(3312));

var _graphSerieBar = _interopRequireDefault(__webpack_require__(2210));

var _graphSerieBox = _interopRequireDefault(__webpack_require__(5096));

var _graphSerieLineColored = _interopRequireDefault(__webpack_require__(9907));

var _graphSerie3 = _interopRequireDefault(__webpack_require__(5718));

var _graphSerieZone = _interopRequireDefault(__webpack_require__(6244));

var _graphSerieZone3d = _interopRequireDefault(__webpack_require__(7328));

var _graphSerieDensitymap = _interopRequireDefault(__webpack_require__(1255));

var _graphSerieContour = _interopRequireDefault(__webpack_require__(2663));

var _graphShape = _interopRequireDefault(__webpack_require__(6141));

var _graphShapeAreaundercurve = _interopRequireDefault(__webpack_require__(5737));

var _graphShapeArrow = _interopRequireDefault(__webpack_require__(5642));

var _graphShapeEllipse = _interopRequireDefault(__webpack_require__(5731));

var _graphShapeLabel = _interopRequireDefault(__webpack_require__(3669));

var _graphShapePolyline = _interopRequireDefault(__webpack_require__(5886));

var _graphShapePolygon = _interopRequireDefault(__webpack_require__(2251));

var _graphShapeLine = _interopRequireDefault(__webpack_require__(6025));

var _graphShapeNmrintegral = _interopRequireDefault(__webpack_require__(6186));

var _graphShapePeakintegration2d = _interopRequireDefault(__webpack_require__(8644));

var _graphShapeRect = _interopRequireDefault(__webpack_require__(8342));

var _graphShapeCross = _interopRequireDefault(__webpack_require__(2941));

var _graphShapePeakboundariescenter = _interopRequireDefault(__webpack_require__(7493));

var _graphShapeHtml = _interopRequireDefault(__webpack_require__(3172));

var _graphPluginDrag = _interopRequireDefault(__webpack_require__(4885));

var _graphPluginShape = _interopRequireDefault(__webpack_require__(8796));

var _graphPluginSelectScatter = _interopRequireDefault(__webpack_require__(366));

var _graphPluginZoom = _interopRequireDefault(__webpack_require__(3175));

var _graphPluginTimeseriemanager = _interopRequireDefault(__webpack_require__(1156));

var _graphPluginSerielinedifference = _interopRequireDefault(__webpack_require__(6010));

var _graphPluginAxissplitting = _interopRequireDefault(__webpack_require__(3525));

var _graphPluginMakeTracesDifferent = _interopRequireDefault(__webpack_require__(6901));

var _graphPluginPeakpicking = _interopRequireDefault(__webpack_require__(267));
...
_graph.default.registerConstructor('graph.position', _graphPosition.default);

_graph.default.registerConstructor('graph.axis.x', _graphAxisX.default);

_graph.default.registerConstructor('graph.axis.y', _graphAxisY.default);

_graph.default.registerConstructor('graph.axis.x.bar', _graphAxisXBar.default);

_graph.default.registerConstructor('graph.axis.x.time', _graphAxisXTime.default);

_graph.default.registerConstructor('graph.serie.line', _graphSerie2.default);

_graph.default.registerConstructor('graph.serie.line.3d', _graphSerieLine3d.default);

_graph.default.registerConstructor('graph.serie.line.color', _graphSerieLineColored.default);

_graph.default.registerConstructor('graph.serie.contour', _graphSerieContour.default);

_graph.default.registerConstructor('graph.serie.histogram', _graphSerie.default);

_graph.default.registerConstructor('graph.serie.bar', _graphSerieBar.default);

_graph.default.registerConstructor('graph.serie.box', _graphSerieBox.default);

_graph.default.registerConstructor('graph.serie.scatter', _graphSerie3.default);

_graph.default.registerConstructor('graph.serie.zone', _graphSerieZone.default);

_graph.default.registerConstructor('graph.serie.zone.3d', _graphSerieZone3d.default);

_graph.default.registerConstructor('graph.serie.densitymap', _graphSerieDensitymap.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.LINE, _graphSerie2.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.HISTOGRAM, _graphSerie.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.LINE_3D, _graphSerieLine3d.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.LINE_COLORED, _graphSerieLineColored.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.CONTOUR, _graphSerieContour.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.BAR, _graphSerieBar.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.BOX, _graphSerieBox.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.SCATTER, _graphSerie3.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.ZONE, _graphSerieZone.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.ZONE_3D, _graphSerieZone3d.default);

_graph.default.registerConstructor(_series.SERIE_TYPE.DENSITY_MAP, _graphSerieDensitymap.default); //Graph.registerConstructor( "graph.serie.line.broken", GraphSerieLineBroken );


_graph.default.registerConstructor('graph.plugin.shape', _graphPluginShape.default);

_graph.default.registerConstructor('graph.plugin.drag', _graphPluginDrag.default);

_graph.default.registerConstructor('graph.plugin.zoom', _graphPluginZoom.default);

_graph.default.registerConstructor('graph.plugin.selectScatter', _graphPluginSelectScatter.default);

_graph.default.registerConstructor('graph.plugin.timeSerieManager', _graphPluginTimeseriemanager.default);

_graph.default.registerConstructor('graph.plugin.serielinedifference', _graphPluginSerielinedifference.default);

_graph.default.registerConstructor('graph.plugin.serieLineDifference', _graphPluginSerielinedifference.default);

_graph.default.registerConstructor('graph.plugin.axissplitting', _graphPluginAxissplitting.default);

_graph.default.registerConstructor('graph.plugin.makeTracesDifferent', _graphPluginMakeTracesDifferent.default);

_graph.default.registerConstructor('graph.plugin.peakPicking', _graphPluginPeakpicking.default);

_graph.default.registerConstructor('graph.shape', _graphShape.default);

_graph.default.registerConstructor('graph.shape.areaundercurve', _graphShapeAreaundercurve.default);

_graph.default.registerConstructor('graph.shape.arrow', _graphShapeArrow.default);

_graph.default.registerConstructor('graph.shape.ellipse', _graphShapeEllipse.default);

_graph.default.registerConstructor('graph.shape.polygon', _graphShapePolygon.default);

_graph.default.registerConstructor('graph.shape.label', _graphShapeLabel.default);

_graph.default.registerConstructor('graph.shape.polyline', _graphShapePolyline.default);

_graph.default.registerConstructor('graph.shape.line', _graphShapeLine.default);

_graph.default.registerConstructor('graph.shape.nmrintegral', _graphShapeNmrintegral.default);

_graph.default.registerConstructor('graph.shape.html', _graphShapeHtml.default);

_graph.default.registerConstructor('graph.shape.peakintegration2d', _graphShapePeakintegration2d.default); //  Graph.registerConstructor( "graph.shape.peakinterval", GraphShapePeakInterval );
...
_graph.default.registerConstructor('graph.shape.rect', _graphShapeRect.default);

_graph.default.registerConstructor('graph.shape.rectangle', _graphShapeRect.default);

_graph.default.registerConstructor('graph.shape.cross', _graphShapeCross.default); //Graph.registerConstructor( "graph.shape.zoom2d", GraphShapeZoom2D );


_graph.default.registerConstructor('graph.shape.peakboundariescenter', _graphShapePeakboundariescenter.default); //   Graph.registerConstructor( "graph.toolbar", GraphToolbar );


_graph.default.registerConstructor('graph.legend', _graphLegend.default);

_graph.default.registerConstructor('graph.waveform', _waveform.Waveform);
...
exports.isPlainObject = exports.isArray = exports.default = void 0;
...
exports.default = exports.EventMixin = exports.trigger = void 0;

const trigger = function (eventName, ...params) {
  var _this$__eventHandlers, _this$__eventHandlers2;

  if ((_this$__eventHandlers = this.__eventHandlers) !== null && _this$__eventHandlers !== void 0 && _this$__eventHandlers[eventName]) {
...
var _graphMixinEvent = __webpack_require__(6871);
...
var _graphSerie = _interopRequireDefault(__webpack_require__(1755));

var _graphSerie2 = _interopRequireDefault(__webpack_require__(5718));

var _graphAxis = _interopRequireDefault(__webpack_require__(4349));

var _graphPlugin = _interopRequireDefault(__webpack_require__(1530));
...
class SerieLineExtended extends _graphSerie.default {
  constructor() {
    super(...arguments);
    this.subSeries = [];
  }
...
class SerieScatterExtended extends _graphSerie2.default {
  constructor() {
    super(...arguments);
    this.subSeries = [];
  }
...
var addMethods = [];
Object.getOwnPropertyNames(_graphSerie.default.prototype).concat(addMethods).map(function (i) {
...
Object.getOwnPropertyNames(_graphSerie.default.prototype).map(function (i) {
...
class PluginAxisSplitting extends _graphPlugin.default {
  constructor(options) {
    super(...arguments);
    this.series = new Map();
  }
  ...
  preDraw() {
    ...
    this.series.forEach(({
      ...
      while (serie.subSeries.length < splits) {
        ...
        const s = this.graph.newSerie(name, {}, serie.getType() || _graph.default.SERIE_LINE);
        s.excludedFromLegend = true;
        s.styles = serie.styles;
        s.waveform = serie.waveform; // Copy data

        if (serie.getType() == _graph.default.SERIE_LINE) {
...
class SplitXAxis extends SplitAxis(_graphAxisX.default) {
  constructor(graph, topbottom, options) {
    super(...arguments);
...
class SplitYAxis extends SplitAxis(_graphAxisY.default) {
  constructor(graph, leftright, options) {
...
var _default = PluginAxisSplitting;
exports.default = _default;
 ...
 * @implements Plugin
 */
class PluginDrag extends _graphPlugin.default {
  static default() {
    return {
      dragX: true,
      dragY: true,
...
(0, _graphMixinEvent_graph.default)(Plugin, "plugin");
var _default = Plugin;
exports.default = _default;
 ...
 * @extends Plugin
 */
class PluginMakeTracesDifferent extends _graphPlugin.default {
  constructor() {
    super(...arguments);
  }
...
var _default = PluginMakeTracesDifferent;
exports.default = _default;
 ...
 * @extends Plugin
 */
class PluginPeakPicking extends _graphPlugin.default {
  constructor() {
    super(...arguments);
  }
...
var _default = PluginPeakPicking;
exports.default = _default;
 ...
 * @extends Plugin
 */
class PluginSelectScatter extends _graphPlugin.default {
  constructor() {
    super(...arguments);
  }
...
var _default = PluginSelectScatter;
exports.default = _default;
 ...
 * @implements Plugin
 */
class PluginSerieLineDifference extends _graphPlugin.default {
  constructor() {
    super(...arguments);
  }
  ...
  draw() {
    ...
    this.series = chunks.forEach((chunk, index) => {
      ...
      const wave = new _waveform.Waveform();
...
var _default = PluginSerieLineDifference;
exports.default = _default;
 ...
 * @implements Plugin
 */
class PluginShape extends _graphPlugin.default {
  constructor() {
    super(...arguments);
  }
...
var _graphLru = _interopRequireDefault(__webpack_require__(3426));
 ...
 * @implements Plugin
 */
class PluginTimeSerieManager extends _graphPlugin.default {
  constructor() {
    super(...arguments);
    this.series = [];
    this.plugins = [];
  ...
  newSerie(serieName, serieOptions, serieType, dbElements, noZoneSerie) {
    ...
    if (!noZoneSerie) {
      s._zoneSerie = this.graph.newSerie(`${serieName}_zone`, {}, _graph.default.SERIE_ZONE);
    }
  ...
  recalculateSerie(serie, force) {
    ...
    while (slotId <= endSlotId) {
      const lruData = _graphLru.default.get(this.options.LRUName, this.computeUniqueID(serie, slotId, interval));
  ...
  recalculateSerieUpwards(serie, downSlotId, downInterval, data, dataMinMax) {
    ...
    const lruData = _graphLru.default.get(this.options.LRUName, this.computeUniqueID(serie, newSlotId, nextInterval));
...
var _default = PluginTimeSerieManager;
exports.default = _default;
 ...
 * @implements Plugin
 */
class PluginZoom extends _graphPlugin.default {
  constructor() {
    super(...arguments);
  }
...
var _style = _interopRequireDefault(__webpack_require__(5579));

var _axes = _interopRequireDefault(__webpack_require__(2166));

var _annotations = _interopRequireDefault(__webpack_require__(7568));
...
var _main = _interopRequireDefault(__webpack_require__(7635));
...
var _default = Graph => {
  ...
  Graph.prototype.setJSON = (json, options = {}) => {
    ...
    (void 0)._applyToAxes(axis => {
      (void 0).killAxis(axis, true, true);
    }, undefined, true, true);

    (void 0).killLegend();
    (void 0).killShapes();
    (0, _main.default)(Graph, void 0, json);
...
var _graphMixinErrorbars = _interopRequireDefault(__webpack_require__(1148));
 ...
 * @extends Serie
 */
class SerieBar extends _graphSerie.default {
...
var _graphUtil = __webpack_require__(4167);

var _graph = _interopRequireDefault(__webpack_require__(7245));
...
class SerieBox extends _graph.default {
 ...
 * @see Graph#newSerie
 */
class SerieContour extends _graphSerie.default {
  constructor(graph, name, options) {
    super(...arguments);
 ...
 * @augments Serie
 */
class SerieDensityMap extends _graph.default {
  constructor(graph, name, options) {
    super(...arguments);
...
var _graph = __webpack_require__(1107);
...
class SerieHistogram extends _graphSerie.default {
  constructor(graph, name, options) {
    super(graph, name, options);

    _defineProperty(this, "options", void 0);

    _defineProperty(this, "_histForLegend", void 0);

    _defineProperty(this, "_histogramWaveform", void 0);

    this.init(); // Unselected style
  ...
  getType() {
    return _series.SERIE_TYPE.HISTOGRAM;
  }
  ...
  getSymbolForLegend() {
    ...
    if (!this._histForLegend) {
      var line = document.createElementNS(_graph.ns, 'polyline');
  ...
  draw(force) {
    ...
    if (force || this.hasDataChanged()) {
      ...
      this.removeExtraLines(); //    this.insertLinesGroup();
    }
  ...
  */
  ...
  _calculateHistogram(xMin, xMax, dX) {
    try {
      ...
      console.warn("Could not calculate histogram"); // TODO: Signal that the serie is invalid and but soft fails the drawing
    }
  }
  ...
  getFillColor() {
    ...
    return (_this$getComputedStyl = this.getComputedStyle().histogram) === null || _this$getComputedStyl === void 0 ? void 0 : _this$getComputedStyl.fillColor;
  }
  ...
  getFillOpacity() {
    ...
    return (_this$getComputedStyl2 = this.getComputedStyle().histogram) === null || _this$getComputedStyl2 === void 0 ? void 0 : _this$getComputedStyl2.fillOpacity;
  }

}

var _default = SerieHistogram;
exports.default = _default;
...
var _graphMixinSerie3d = _interopRequireDefault(__webpack_require__(6190));
 ...
 * @extends SerieLine
 */
class SerieLine3D extends _graphSerie.default {
  static defaults() {
    return {
      zpos: 0
    };
 ...
 * @augments SerieLine
 */
class SerieLineColor extends _graphSerie.default {
  constructor(graph, name, options) {
    super(...arguments);
  ...
  getSymbolForLegend() {
    ...
    if (!this.defined) {
      ...
      gradient.appendChild(stop2); //this.defs.appendChild(gradient);
...
exports.default = exports.Dasharray = void 0;

var _graph = __webpack_require__(5936);

var _graph2 = __webpack_require__(1107);

var util = _interopRequireWildcard(__webpack_require__(4167));

var _graphMixinErrorbars = _interopRequireDefault(__webpack_require__(1148));

var _graphSerie = _interopRequireDefault(__webpack_require__(5718));
...
})(Dasharray || (exports.Dasharray = Dasharray = {}));
...
class SerieLine extends _graphSerie.default {
  constructor(graph, name, options) {
    super(graph, name, options);

    _defineProperty(this, "options", void 0);

    _defineProperty(this, "_lineForLegend", void 0);

    _defineProperty(this, "_degradationPx", void 0);
    ...
    this.groupLines = document.createElementNS(_graph2.ns, 'g');
    this.domMarker = document.createElementNS(_graph2.ns, 'path');
    ...
    this.additionalData = {};
    this.marker = document.createElementNS(_graph2.ns, 'circle');
    this.marker.setAttribute('fill', 'black');
    this.marker.setAttribute('r', 3);
    this.marker.setAttribute('display', 'none');
    this.markerLabel = document.createElementNS(_graph2.ns, 'text');
    this.markerLabelSquare = document.createElementNS(_graph2.ns, 'rect');
    this.markerLabelSquare.setAttribute('fill', 'white');
    this.domMarkerHover = {};
    this.domMarkerSelect = {};
    this.markerHovered = 0;
    this.groupMarkerSelected = document.createElementNS(_graph2.ns, 'g');
  ...
  getSymbolForLegend() {
    ...
    if (!this._lineForLegend) {
      var line = document.createElementNS(_graph2.ns, 'line');
      this.applyLineStyle(line);
...
class SerieScatter extends _graph.default {
  constructor(graph, name, options) {
    super(graph, name, options);
  ...
  extendScatterOptions(options) {
    options = super.extendOptions(options);
  ...
  getMarkerStyle(indices, noSetPosition) {
    ...
    for (let i = 0, l = _indices.length; i < l; i++) {
      ...
      if (modifier && (modifierIsFunc || modifier[index])) {
        ...
        if (modifierIsFunc) {
          modifiedStyle = modifier.call(this, this.waveform.getX(index), this.waveform.getY(index), index, shape, styleAll);

          if (modifiedStyle === false) {
            modifiedStyle = {};

            if (shape) {
              shape.setAttribute('display', 'none'); //    console.log('n');

              continue;
            } else {}
          } else {//     console.log(index, indices);
          }
...
var _graph = _interopRequireWildcard(__webpack_require__(1107));
...
class Serie {
  constructor(graph, name, options = {}) {
    ...
    _defineProperty(this, "groupMain", void 0);

    _defineProperty(this, "symbolLegendContainer", void 0);

    _defineProperty(this, "_activeStyleName", void 0);

    _defineProperty(this, "_unselectedStyleName", void 0);
    ...
    _defineProperty(this, "shown", true);

    _defineProperty(this, "selected", false);

    _defineProperty(this, "waveform", undefined);

    this.options = util.extend(true, {}, options);
    this.graph = graph;
    this.name = name;
    this.groupMain = document.createElementNS(_graph.ns, 'g');
    this.symbolLegendContainer = document.createElementNS(_graph.ns, 'g');
    this.init(); // Creates an empty style variable
  ...
  getWaveform() {
    if (!this.waveform) {
      this.waveform = _graph.default.newWaveform();
    }
  ...
  extendStyle(data, styleName = 'unselected', baseStyleName = 'unselected') {
...
(0, _graphMixinEvent_graph.default)(Serie, 'serie');
var _default = Serie;
exports.default = _default;
...
var _graphSerie = _interopRequireDefault(__webpack_require__(6244));
 ...
 * @extends SerieLine
 */
class SerieZone3D extends _graphSerie.default {
  static default() {
    return {
      zpos: 0
    };
 ...
 * @see Graph#newSerie
 */
class SerieZone extends _graph.default {
  static default() {
    return {
 ...
 *  @extends GraphShape
 */
class ShapeSurfaceUnderCurve extends _graphShape.default {
  createDom() {
 ...
 */
class ShapeArrow extends _graphShapeLine.default {
  constructor(graph) {
    super(graph);
  }
 ...
 *  @extends Shape
 */
class ShapeCross extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
    this.nbHandles = 1;
  }
 ...
 * @extends Shape
 */
class ShapeEllipse extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
  }
 ...
 * @see Graph#newShape
 */
class ShapeHTML extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
  }
  /**
...
class Shape {
      ...
      switch (transforms[i].type) {
        case 'translate':
          if (transforms[i].arguments) {
            ...
            const value = _graphPosition.default.check(transforms[i].value);
        ...
        case 'rotate':
          ...
          if (!transforms[i].arguments) {
            ...
            if (!transforms[i].center) {
              ...
              const posCenter = _graphPosition.default.check(transforms[i].center).compute(this.graph, this.getXAxis(), this.getYAxis(), this.getSerie());
  ...
  _applyLabelData(labelIndex) {
    ...
    if (this.getProp('labelSize', labelIndex)) {
      this._labels[labelIndex].setAttribute('font-size', `${this.getProp('labelSize', labelIndex) || 12}px`);
    }
    /** Sets the anchor */
...
(0, _graphMixinEvent_graph.default)(Shape, 'shape');
var _default = Shape;
exports.default = _default;
 ...
 * @extend GraphShape
 */
class ShapeLabel extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
  }
 ...
 * @see Graph#newShape
 */
class ShapeLine extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
  }
  /**
 ...
 */
class ShapeNMRIntegral extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
    this.nbHandles = 2;
  }
 ...
 *  @extends ShapeLine
 */
class ShapePeakBoundaries extends _graphShapeLine.default {
  constructor(graph) {
    super(graph);
    this.lineHeight = 6;
  }
...
class ShapePeakIntegration2D extends _graphShapeRect.default {
  constructor(graph, options) {
    super(graph, options);
    this.nbHandles = 4;
  }
 ...
 * @see Graph#newShape
 */
class ShapeRectangle extends _graphShape.default {
  constructor(graph, options) {
    super(graph, options);
  }
  /**
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "WaveformHash": () => (/* binding */ WaveformHash)
});

// EXTERNAL MODULE: ./src/graph.util.js
var graph_util = __webpack_require__(4167);
;// CONCATENATED MODULE: ./src/util/data_aggregator.js
var dataAggregator;
...
/* harmony default export */ const data_aggregator = (dataAggregator);
;// CONCATENATED MODULE: ./src/util/fit_lm.js
class FitHost {
  constructor(options) {
    this.DELTAP = 1e-6;
    this.BIGVAL = 9e99;
...
/* harmony default export */ const fit_lm = (FitHost); //module.export = FitHost
;// CONCATENATED MODULE: ./src/util/waveform.ts
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
class Waveform {
  constructor(data = [], xOffset = 0, xScale = 1) {
    ...
    _defineProperty(this, "_originalData", []);

    _defineProperty(this, "_originalDataX", []);

    _defineProperty(this, "_xdata", void 0);

    _defineProperty(this, "_data", []);

    _defineProperty(this, "minX", Number.MIN_SAFE_INTEGER);

    _defineProperty(this, "maxX", Number.MAX_SAFE_INTEGER);

    _defineProperty(this, "minY", Number.MIN_SAFE_INTEGER);

    _defineProperty(this, "maxY", Number.MAX_SAFE_INTEGER);

    _defineProperty(this, "_monotoneous", false);

    _defineProperty(this, "_monotoneousAscending", false);

    _defineProperty(this, "dataInUseType", "");

    _defineProperty(this, "dataInUse", {
      x: [],
      y: []
    });

    _defineProperty(this, "_typedArrayClass", void 0);

    _defineProperty(this, "_dataAggregating", void 0);

    _defineProperty(this, "_dataAggregated", {});

    _defineProperty(this, "_dataAggregationDirection", "");

    _defineProperty(this, "unit", void 0);

    _defineProperty(this, "xunit", void 0);

    this.xOffset = xOffset;
    this.xScale = xScale;
    this.shift = 0;
    this.scale = 1; // Error bar handling
  ...
  setTypedArrayClass(constructor) {
    if (this.getTypedArrayClass() && this.isNaNAllowed() && !this.isNaNAllowed(constructor)) {
      this.warn(`NaN values are not allowed by the new constructor (${constructor.name}) while it was allowed by the previous one (${this._typedArrayClass})`);
    }
  ...
  append(x, y) {
    ...
    if (this._monotoneous) {
      if (y > this._data[this._data.length - 1] && this.getMonotoneousAscending() === false) {
        this._monotoneous = false;
      } else if (y < this._data[this._data.length - 1] && this.getMonotoneousAscending() === true) {
        this._monotoneous = false;
      }
    }
  ...
  getIndexFromVal(val, useDataToUse = false, roundingMethod = Math.round) {
    ...
    let position;
    position = this.getIndexFromMonotoneousData(val, data, this.getMonotoneousAscending());
  ...
  getIndexFromX(xval, useDataToUse = false, roundingMethod = Math.round) {
    ...
    if (this.hasXWaveform()) {
      if (this.isXMonotoneous()) {
        position = this._xdata.getIndexFromMonotoneousData(xval, xdata, this._xdata.getMonotoneousAscending());
      } else {
  ...
  */
  ...
  fit(options) {
    ...
    return new Promise(function (resolver, rejector) {
      var fit = new fit_lm(graph_util.extend({}, {
        dataY: self,
  ...
  resampleForDisplay(options) {
    ...
    if (this._xdata && !this._xdata.getMonotoneousAscending() || !this._xdata && this.xScale < -0) {
      inverting = true;
      i = l;
    }
  ...
  aggregate(direction = 'x') {
    ...
    this._dataAggregating = data_aggregator({
      minX: this.minX,
      maxX: this.maxX,
      minY: this.minY,
      maxY: this.maxY,
  ...
  subrangeX(fromX, toX) {
    if (!this._xdata) {
      ...
      return new Waveform().setData(this._data.slice(fromP, toP)).rescaleX(this.xOffset, this.xScale);
    } else {
  ...
  findLevels(level, options) {
    ...
    while (lvlIndex = this.findLevel(level, graph_util.extend(true, {}, options, {
          ...
          for (let j = i + (box - 1) / 2; j >= i - (box - 1) / 2; j--) {
            if (this._data[j] >= level && this._data[j - 1] <= level) {
              ...
              switch (options.rounding) {
                ...
                case 'interpolate':
                  return getIndexInterpolate(level, this._data[j], this._data[j - 1], j, j - 1);
                  break;
              }
            }
          }
  ...
  getMaxError(i, side = ErrorPosition.ABOVE) {
    return Math.max(this.getMaxErrorType(i, side, ErrorType.BOX), this.getMaxErrorType(i, side, ErrorType.BAR));
  }
  ...
  hasErrorBars() {
    return this.errors.nb > 0 || this.hasXWaveform() && this._xdata.errors.nb > 0;
  }
...
(function (ErrorPosition) {
  ErrorPosition[ErrorPosition["ABOVE"] = 0] = "ABOVE";
  ErrorPosition[ErrorPosition["BELOW"] = 1] = "BELOW";
})(ErrorPosition || (ErrorPosition = {}));

var ErrorType;

(function (ErrorType) {
  ErrorType[ErrorType["BOX"] = 0] = "BOX";
  ErrorType[ErrorType["BAR"] = 1] = "BAR";
})(ErrorType || (ErrorType = {}));
...
exports.SERIE_TYPE = exports.SERIE_DEFAULT_STYLE = void 0;
const SERIE_DEFAULT_STYLE = {
  line: {
    color: 'black'
  }
};
exports.SERIE_DEFAULT_STYLE = SERIE_DEFAULT_STYLE;
let SERIE_TYPE;
exports.SERIE_TYPE = SERIE_TYPE;
...
})(SERIE_TYPE || (exports.SERIE_TYPE = SERIE_TYPE = {}));
...
/******/ 	var __webpack_exports__ = __webpack_require__(5936);
