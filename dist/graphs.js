...
/* 
 * Build: new source file 
 * File name : graph.serie
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.serie.js
 */

build['./graph.serie'] = ( function( $, GraphSerieNonInstanciable ) { 
...
//				this.slotsData[ this.slots[ i ] ].max = this.data[ j ][ m ];
	...
	return GraphSerie;
 } ) ( build['jquery'],build[ './graph._serie'] );


// Build: End source file (graph.serie) 
...
/* 
 * Build: new source file 
 * File name : graph.serie.contour
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.serie.contour.js
 */

build['./graph.serie.contour'] = ( function( GraphSerie ) { 
...
// Build: End source file (graph.serie.contour) 
...
/* 
 * Build: new source file 
 * File name : graph.serie.scatter
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.serie.scatter.js
 */

build['./graph.serie.scatter'] = ( function( GraphSerieNonInstanciable ) { 
...
// Build: End source file (graph.serie.scatter) 
...
/* 
 * Build: new source file 
 * File name : graph.serie.zone
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.serie.zone.js
 */

build['./graph.serie.zone'] = ( function( GraphSerieNonInstanciable ) { 
...
// Build: End source file (graph.serie.zone) 
...
build['./graph.core'] = ( function( $,GraphXAxis,GraphYAxis,GraphSerie,GraphSerieContour,GraphSerieScatter,GraphSerieZone,GraphLegend, DynamicDepencies) { 
...
//			Array.prototype.splice.apply(args, [0, 0, this]);
	...
	return Graph;
 } ) ( build['jquery'],build[ './graph.axis.x'],build['./graph.axis.y'],build['./graph.serie'],build['./graph.serie.contour'],build['./graph.serie.scatter'],build['./graph.serie.zone'],build['./graph.legend'],build[ './dynamicdepencies'] );
...
/* 
 * Build: new source file 
 * File name : graph.shape
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.js
 */

build['./graph.shape'] = ( function( ) { 
...
// Build: End source file (graph.shape) 
...
build['./plugins/graph.plugin.linking'] = ( function( GraphShape ) { 
...
/* 
 * Build: new source file 
 * File name : graph.shape.areaundercurve
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.areaundercurve.js
 */

build['./graph.shape.areaundercurve'] = ( function( GraphShape ) { 
...
// Build: End source file (graph.shape.areaundercurve) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.line
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.line.js
 */

build['./graph.shape.line'] = ( function( GraphShape ) { 
...
// Build: End source file (graph.shape.line) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.arrow
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.arrow.js
 */

build['./graph.shape.arrow'] = ( function( GraphLine ) { 
...
/*
 ...
 } ) ( build['./graph.shape.line' ] );


// Build: End source file (graph.shape.arrow) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.label
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.label.js
 */

build['./graph.shape.label'] = ( function( GraphShape ) { 
...
// Build: End source file (graph.shape.label) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.nmrintegral
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.nmrintegral.js
 */

build['./graph.shape.nmrintegral'] = ( function( GraphSurfaceUnderCurve ) { 
 ...
 } ) ( build['./graph.shape.areaundercurve' ] );


// Build: End source file (graph.shape.nmrintegral) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.rect
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.rect.js
 */

build['./graph.shape.rect'] = ( function( GraphShape ) { 
...
// Build: End source file (graph.shape.rect) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.peakintegration2d
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.peakintegration2d.js
 */

build['./graph.shape.peakintegration2d'] = ( function( GraphRect ) { 
 ...
 } ) ( build['./graph.shape.rect' ] );


// Build: End source file (graph.shape.peakintegration2d) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.peakinterval
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.peakinterval.js
 */

build['./graph.shape.peakinterval'] = ( function( GraphLine ) { 
...
// Build: End source file (graph.shape.peakinterval) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.peakinterval2
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.peakinterval2.js
 */

build['./graph.shape.peakinterval2'] = ( function( GraphLine ) { 
...
// Build: End source file (graph.shape.peakinterval2) 
...
/* 
 * Build: new source file 
 * File name : graph.shape.rangex
 * File path : /Users/normanpellet/Documents/Web/graph/src/graph.shape.rangex.js
 */

build['./graph.shape.rangex'] = ( function( GraphSurfaceUnderCurve ) { 
...
// Build: End source file (graph.shape.rangex) 
