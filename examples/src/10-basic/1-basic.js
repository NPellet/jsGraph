...
$.when( 
  ...
  var trackLine = graph.trackingLine( {
    ...
    independentLegends: true,
    independentLegendsText: function( output ) {
      
      return "California: " + Math.round( output[ "CA" ].yValue ) + " ktons<br />Colorado: " + Math.round( output[ "CO" ].yValue ) + " ktons"
    },
