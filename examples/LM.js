...
class FitHost {
  ...
  fit() {
    ...
    return new Waveform( this.parms );
  }
  ...
  log( message ) {
    ...
    buildFit( parms, length ) {
      ...
      let waveformResult = new Waveform();
