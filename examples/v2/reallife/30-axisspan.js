...
colorado = Graph.newWaveform().setData( colorado.map( e => e[ 1 ] ), colorado.map( e => e[ 0 ] ) );
california = Graph.newWaveform().setData( california.map( e => e[ 1 ] ), california.map( e => e[ 0 ] ) );
kentucky = Graph.newWaveform().setData( kentucky.map( e => e[ 1 ] ), kentucky.map( e => e[ 0 ] ) );

graph
  .newSerie( "colorado" )
  .setWaveform( colorado )
  .autoAxis()
