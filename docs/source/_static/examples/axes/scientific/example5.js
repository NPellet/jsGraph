...
const g = new Graph('example-5');

let w = Graph.newWaveform().setData(coalConsumption, years);
w.setScale(
...
g.updateDataMinMaxAxes();

g.getBottomAxis().setLabel('year');
g.getLeftAxis().setUnit('GWh').setUnitWrapper('[', ']').setScientific(false).setExponentialFactor(-9);
