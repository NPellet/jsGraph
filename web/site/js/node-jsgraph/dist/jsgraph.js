...
*/
    ...
    build[ './graph.axis' ] = ( function( EventEmitter, util ) {
      ...
      Axis.prototype.setMinMaxToFitSeries = function( noNotify ) {
        ...
        console.log( this.getMinValue(), this.getMaxValue() );
        this.cacheCurrentMin();
        this.cacheCurrentMax();
        this.cacheInterval();
...
*/
    ...
    build[ './series/graph.serie.densitymap' ] = ( function( SerieNonInstanciable, util ) {
       ...
       * the calculation of the density map. In this method, the color map spans on the full scale of the density map values (i.e. a subrange cannot be defined, like you would do using {@link SerieDensityMap#setBinsBoundaries}).
       * @memberof SerieDensityMap
       ...
       * serie.setBinsBoundaries( serie.binMin * 2, serie.binMax ); 
       */
       ...
       * As of now, all the colors in colorStops will be places at equal distances from each other between <code>colorMapMin</code> and <code>colorMapMax</code> set by {@link autoColorMapBinBoundaries} or {@link setBinsBoundaries}
       * @memberof SerieDensityMap
