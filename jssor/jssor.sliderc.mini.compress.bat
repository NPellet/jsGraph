...
SET RESERVE_MEMBERNAMES3=%RESERVE_MEMBERNAMES3%,$JssorEasing$,$JssorSlider$,$JssorBulletNavigator$,$JssorArrowNavigator$,$JssorThumbnailNavigator$,$JssorCaptionSlider$
